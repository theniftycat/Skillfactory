# Есть еще нюансы, которые я бы исправила, например, глюк с кораблями встык, но он редкий.
# В последнюю очередь добавила выделение смежных клеток при попадании в длинные корабли, работает не идеально, но я уже слишком много всего сделала и так.
# Самым важным и интересным для меня было, чтобы компьютер иногда побеждал. Этого я добилась.
# вывести поля
F1 = [[" ", "1", "2", "3", "4", "5", "6"],
     ["1", "O", "O", "O", "O", "O", "O"],
     ["2", "O", "O", "O", "O", "O", "O"],
